...
public class BooleanExprParser extends Parser {
	...
	public static final int
		LPARENTHESIS=11, OR=2, LT=8, TRUE=4, EQ=10, DECIMAL_NUMBER=13, GT=6, RPARENTHESIS=12, 
		NOT=3, AND=1, LE=9, FALSE=5, IDENTIFIER=14, WS=15, GE=7;
	public static final String[] tokenNames = {
		"<INVALID>", "AND", "OR", "NOT", "'True'", "'False'", "GT", "GE", "LT", 
		"LE", "EQ", "'('", "')'", "DECIMAL_NUMBER", "IDENTIFIER", "WS"
	};
	public static final int
	...
	public final ParseContext parse() throws RecognitionException {
		...
		try {
			...
			{
			setState(12); ((ParseContext)_localctx).basicBooleanExpression = basicBooleanExpression(0);
	...
	private BasicBooleanExpressionContext basicBooleanExpression(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(17); ((ComparisonExpressionContext)_localctx).left = expression();
				setState(18); ((ComparisonExpressionContext)_localctx).op = comparator();
				setState(19); ((ComparisonExpressionContext)_localctx).right = expression();
			...
			case 2:
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(22); ((BooleanExpressionContext)_localctx).bool = bool();
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					setState(28); ((LogicalExpressionContext)_localctx).op = logicalOperator();
					setState(29); ((LogicalExpressionContext)_localctx).right = basicBooleanExpression(4);
	...
	public final ExpressionContext expression() throws RecognitionException {
		...
		try {
			...
			case LPARENTHESIS:
				...
				enterOuterAlt(_localctx, 1);
				{
				setState(37); match(LPARENTHESIS);
				setState(38); expression();
				setState(39); match(RPARENTHESIS);
				}
				break;
			case NOT:
			...
			case DECIMAL_NUMBER:
				...
				{
				setState(45); match(DECIMAL_NUMBER);
				}
				break;
			default:
	...
	public boolean sempred(RuleContext _localctx, int ruleIndex, int predIndex) {
		switch (ruleIndex) {
		case 1: return basicBooleanExpression_sempred((BasicBooleanExpressionContext)_localctx, predIndex);
		}
		return true;
	}
	...
	public static final String _serializedATN =
		...
		"\3\7\3\7\2\3\4\b\2\4\6\b\n\f\2\5\3\2\b\f\3\2\3\4\3\2\6\78\2\16\3\2\2\2"+
		"\4\33\3\2\2\2\6\60\3\2\2\2\b\62\3\2\2\2\n\64\3\2\2\2\f\66\3\2\2\2\16\17"+
		"\5\4\3\2\17\20\b\2\1\2\20\21\7\2\2\3\21\3\3\2\2\2\22\23\b\3\1\2\23\24"+
		"\5\6\4\2\24\25\5\b\5\2\25\26\5\6\4\2\26\27\b\3\1\2\27\34\3\2\2\2\30\31"+
		"\5\f\7\2\31\32\b\3\1\2\32\34\3\2\2\2\33\22\3\2\2\2\33\30\3\2\2\2\34$\3"+
		"\2\2\2\35\36\f\5\2\2\36\37\5\n\6\2\37 \5\4\3\6 !\b\3\1\2!#\3\2\2\2\"\35"+
		"\3\2\2\2#&\3\2\2\2$\"\3\2\2\2$%\3\2\2\2%\5\3\2\2\2&$\3\2\2\2\'(\7\r\2"+
		"\2()\5\6\4\2)*\7\16\2\2*\61\3\2\2\2+,\7\5\2\2,\61\5\6\4\2-\61\5\f\7\2"+
		".\61\7\20\2\2/\61\7\17\2\2\60\'\3\2\2\2\60+\3\2\2\2\60-\3\2\2\2\60.\3"+
		"\2\2\2\60/\3\2\2\2\61\7\3\2\2\2\62\63\t\2\2\2\63\t\3\2\2\2\64\65\t\3\2"+
		"\2\65\13\3\2\2\2\66\67\t\4\2\2\67\r\3\2\2\2\5\33$\60";
